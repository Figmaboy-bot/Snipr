var SnprFirebaseAuth = (() => {
  ...
  __export(firebase_auth_exports, {
    cloudDeleteSave: () => cloudDeleteSave,
    cloudPushSaves: () => cloudPushSaves,
    cloudSyncMeta: () => cloudSyncMeta,
    default: () => firebase_auth_default,
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
  ...
  function isConfigReady() {
    return firebaseConfig && typeof firebaseConfig.apiKey === "string" && firebaseConfig.apiKey.length > 0 && firebaseConfig.apiKey !== "YOUR_API_KEY";
  }
  ...
  async function cloudPushSaves(saves) {
  ...
  async function cloudSyncMeta(folders, categories) {
    const user = requireUser();
    await setDoc(
  ...
  var firebase_auth_default = SnprFirebaseAuth;
